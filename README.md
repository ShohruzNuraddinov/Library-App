...
Give permission to docker script: ```chmod +x entrypoint.sh```

### Docker compose file

Build and docker up containers: ```docker-compose up -d --build```

### Use docker-compose file

```./docker-compose makemigrations```
or ```docker-compose exec web python manage.py makemigrations```
